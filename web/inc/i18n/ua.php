...
$LANG['ua'] = array(
    ...
    'Editing Backup Exclusions' => 'Налаштування винятків архіву',
    ...
    'backup exclusions' => 'винятки архіву',
    'template' => 'шаблон',
    ...
    'Records' => 'Записи',
    'Serial'  => 'Serial',
    'Catchall email' => 'Пастка для пошти',
    ...
    'USER_CREATED_OK' => 'Акаунт <a href="/edit/user/?user=%s"><b>%s</b></a> успішно створено',
    ...
    'BANLIST_CREATED_OK' => 'Адреса IP була заборонена успішно',    // I'm not sure about this text
    ...
    'DELETE_EXCLUSION_CONFIRMATION' => 'Ви впевнені, що хочете видалити виняток %s?',
    ...
    'Invalid username or code' => 'Некоректний логін або код зміни пароля',
    ...
    'GREETINGS' => "Вітаємо,\n",
    'ACCOUNT_READY' => "Ваш акаунт успішно створено і готовий до використання.\n\nhttps://%s/login/\nІмʼя користувача: %s\nПароль: %s\n\n--\nПанель керування Vesta\n",

    'FTP login credentials' => 'Дані доступу до FTP',
    'FTP_ACCOUNT_READY' => "FTP акаунт успішно створено і готовий до використання.\n\nХост: %s\nІмʼя користувача: %s_%s\nПароль: %s\n\n--\nПанель керування Vesta\n",
    ...
    'RESET_CODE_SENT' => 'Код для відновлення пароля успішно відправлено на вашу електронну пошту.<br>',
    'MAIL_RESET_SUBJECT' => 'Відновлення пароля %s',
    'PASSWORD_RESET_REQUEST'=>"Щоб відновити пароль, будь-ласка, перейдіть за посиланням :\nhttps://%s/reset/?action=confirm&user=%s&code=%s\n\nТакож ви можете відкрити сторінку https://%s/reset/?action=code&user=%s і вручну ввести код для відновлення:\n%s\n\nЯкщо ви не виконували процедуру відновлення пароля, будь ласка, проігноруйте цей лист і прийміть наші вибачення.\n\n--\nПанель керування Vesta\n",
    ...
    'Local backup' => 'Локальне архівування',
    'Compression level' => 'Рівень стискання',
    'Directory' => 'Тека',
    'Remote backup' => 'Віддалене архівування',
    'ftp' => 'FTP',
    'sftp' => 'SFTP',
    ...
    'Hit' => 'Натисніть',
    'to reload the page' => 'щоб перевантажити сторінку',
    ...
    'No file selected' => 'Немає вибраного файлу',
    'No file or folder selected' => 'Немає вибраного файлу або теки',
    'File type not supported' => 'Не підтримуваний тип файлу',
    ...
    'YOU ARE REMOVING' => 'ВИ ПЕРЕМІЩАЄТЕ',
    'Delete items' => 'Видалити елемент',
    'Copy files' => 'Копіювати елемент',
    'Move files' => 'Перемістити елемент',
    'Are you sure you want to copy' => 'Ви впевнені, що ви хочете копіювати',
    'Are you sure you want to move' => 'Ви впевнені, що ви хочете перемістити',
    'Are you sure you want to delete' => 'Ви впевнені, що ви хочете видилити',
    'into' => 'into',
